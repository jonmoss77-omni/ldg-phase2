...
const camera = new THREE.PerspectiveCamera(90, 1, 0.1, 280);
// Camera sits eight feet inside the 60 ft shell. The vehicles are intentionally
// reserved for the rear third so their nearest edge remains over 24 ft away.
...
const frontLight = new THREE.PointLight(0xfff2df, 70, 100, 1.5);
frontLight.position.set(14, 14, -8);
scene.add(frontLight);
const rearLight = new THREE.PointLight(0xe5eff8, 60, 100, 1.5);
rearLight.position.set(14, 16, -50);
scene.add(rearLight);

new MTLLoader()
  .setPath('./')
  .load('ldg-signature-proof-scene.mtl', (materials) => {
    materials.preload();
    new OBJLoader()
      .setMaterials(materials)
      .setPath('./')
      .load('ldg-signature-proof-scene.obj', (model) => {
